...
// ── רשימת טיפולים / פרוצדורות שניתנו בשטח ─────────────────

export const PROCEDURES_BY_CATEGORY: { category: string; items: string[] }[] = [
  {
    category: 'נתיב אוויר',
    items: [
      'פתיחת נתיב אוויר (ידנית)',
      'Jaw-thrust / Head-tilt',
      'הכנסת OP airway (Guedel)',
      'הכנסת NP airway',
      'אינטובציה אורוטרכיאלית (RSI)',
      'אינטובציה נאזוטרכיאלית',
      'LMA / i-gel',
      'Combitube',
      'ניקוב קריקוטירואיד (Cric)',
      'כריתת קריקוטירואיד',
    ],
  },
  {
    category: 'נשימה וחמצן',
    items: [
      'מתן חמצן – קנולה',
      'מתן חמצן – מסיכה פשוטה',
      'מתן חמצן – NRB 15L',
      'הנשמה ב-BVM',
      'CPAP',
      'הנשמה מכנית (מנשם)',
      'ניקוז פנאומותורקס – מחט (Needle Decompression)',
      'הכנסת נקז חזה (Chest tube)',
      'כיסוי פצע חזה אוחז (Chest seal)',
      'Nebulizer (סלבוטמול/Atrovent)',
    ],
  },
  {
    category: 'מחזור הדם / CPR',
    items: [
      'CPR – לחיצות חזה',
      'AED – הדבקת מדבקות',
      'דפיברילציה (Defib)',
      'קרדיוברסיה מסונכרנת',
      'קצב חיצוני (Transcutaneous Pacing)',
      'ROSC',
      'עיסוי לב פתוח',
    ],
  },
  {
    category: 'גישה ורידית',
    items: [
      'גישה ורידית פריפרית (IV)',
      'גישה תוך-עצמית (IO)',
      'גישה ורידית מרכזית (CVC)',
      'שטיפת נוזל – NaCl 0.9%',
      'שטיפת נוזל – Ringer Lactate',
      'שטיפת נוזל – אחר',
      'מתן נוזלים – Bolus',
    ],
  },
  {
    category: 'עצירת דימום וטראומה',
    items: [
      'לחץ ישיר על פצע',
      'חבישה לוחצת',
      'תורניקט – גפה עליונה ימין',
      'תורניקט – גפה עליונה שמאל',
      'תורניקט – גפה תחתונה ימין',
      'תורניקט – גפה תחתונה שמאל',
      'תורניקט מפשעה (Junction tourniquet)',
      'QuikClot / חבישה המוסטטית',
      'סגירת פצע (חבישה / סיכות)',
      'פינוי מהיר (Rapid extrication)',
      'חילוץ מרכב',
    ],
  },
  {
    category: 'אגן ועמוד שדרה',
    items: [
      'קיבוע עמוד שדרה צווארי (צווארון)',
      'קרש שדרה (Long spine board)',
      'KED – קיבוע בישוב',
      'קיבוע אגן (Pelvic binder)',
      'ריפוד ותמיכה',
    ],
  },
  {
    category: 'שברים וגפיים',
    items: [
      'סד קשיח (Splint)',
      'סד ואקום',
      'סד ציר',
      'סד לידה (Traction splint)',
      'קיבוע אצבע',
      'קיבוע שורש כף היד',
    ],
  },
  {
    category: 'כוויות / היפותרמיה',
    items: [
      'קירור פצע כווייה – מים',
      'חבישת כווייה (Burnshield)',
      'שמיכה חמה / Thermal blanket',
      'הסרת בגדים ותכשיטים',
    ],
  },
  {
    ...
    items: [
      'ניטור ECG (12-lead)',
      'ניטור SpO₂',
      'ניטור לחץ דם (אוטומטי)',
      'ניטור EtCO₂ (קפנוגרפיה)',
      'בדיקת גלוקוז (Glucometer)',
      'בדיקת טמפרטורה',
      'קריאת 12-lead ECG',
    ],
  },
  {
    category: 'נוירו / פסיכיאטרי',
    items: [
      'ריסון פיזי',
      'תמיכה נפשית',
      'הגנה עצמית',
...
// פלט שטוח לחיפוש
export const ALL_PROCEDURES = PROCEDURES_BY_CATEGORY.flatMap((c) => c.items)
